...
class LoginResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LoginResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'chat'), createEmptyInstance: create)
...
class LogoutRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LogoutRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'chat'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'clientId')
    ..hasRequiredFields = false
  ;
...
class LogoutResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LogoutResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'chat'), createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'success')
    ..hasRequiredFields = false
  ;
...
class ListRoomsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListRoomsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'chat'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'clientId')
    ..hasRequiredFields = false
  ;
...
class RoomInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RoomInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'chat'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..a<$core.int>(2, _omitFieldNames ? '' : 'memberCount', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
...
class ListRoomsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListRoomsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'chat'), createEmptyInstance: create)
    ..pc<RoomInfo>(1, _omitFieldNames ? '' : 'rooms', $pb.PbFieldType.PM, subBuilder: RoomInfo.create)
    ..hasRequiredFields = false
  ;
...
class JoinRoomRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'JoinRoomRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'chat'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'clientId')
    ..aOS(2, _omitFieldNames ? '' : 'roomId')
    ..hasRequiredFields = false
  ;
...
class JoinRoomResponse extends $pb.GeneratedMessage {
  factory JoinRoomResponse({
    $core.bool? success,
    $core.Iterable<ChatMessage>? recentMessages,
    $core.String? error,
  }) {
    final $result = create();
    if (success != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'JoinRoomResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'chat'), createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'success')
    ..pc<ChatMessage>(2, _omitFieldNames ? '' : 'recentMessages', $pb.PbFieldType.PM, subBuilder: ChatMessage.create)
    ..aOS(3, _omitFieldNames ? '' : 'error')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<ChatMessage> get recentMessages => $_getList(1);
...
class LeaveRoomRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LeaveRoomRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'chat'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'clientId')
    ..aOS(2, _omitFieldNames ? '' : 'roomId')
    ..hasRequiredFields = false
  ;
...
class LeaveRoomResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LeaveRoomResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'chat'), createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'success')
...
class NewMessageEvent extends $pb.GeneratedMessage {
  ...
  NewMessageEvent._() : super();
  factory NewMessageEvent.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory NewMessageEvent.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NewMessageEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'chat'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  NewMessageEvent clone() => NewMessageEvent()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  NewMessageEvent copyWith(void Function(NewMessageEvent) updates) => super.copyWith((message) => updates(message as NewMessageEvent)) as NewMessageEvent;
  ...
  static $pb.PbList<NewMessageEvent> createRepeated() => $pb.PbList<NewMessageEvent>();
  @$core.pragma('dart2js:noInline')
  static NewMessageEvent getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<NewMessageEvent>(create);
...
class UserEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'chat'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'clientId')
    ..aOS(2, _omitFieldNames ? '' : 'username')
...
class ChatServiceApi {
  ...
  $async.Future<LoginResponse> login($pb.ClientContext? ctx, LoginRequest request) =>
    _client.invoke<LoginResponse>(ctx, 'ChatService', 'Login', request, LoginResponse())
  ;
  $async.Future<LogoutResponse> logout($pb.ClientContext? ctx, LogoutRequest request) =>
    _client.invoke<LogoutResponse>(ctx, 'ChatService', 'Logout', request, LogoutResponse())
  ;
  $async.Future<SendMessageResponse> sendMessage($pb.ClientContext? ctx, SendMessageRequest request) =>
    _client.invoke<SendMessageResponse>(ctx, 'ChatService', 'SendMessage', request, SendMessageResponse())
  ;
  $async.Future<GetMessagesResponse> getMessages($pb.ClientContext? ctx, GetMessagesRequest request) =>
    _client.invoke<GetMessagesResponse>(ctx, 'ChatService', 'GetMessages', request, GetMessagesResponse())
  ;
  $async.Future<ListRoomsResponse> listRooms($pb.ClientContext? ctx, ListRoomsRequest request) =>
    _client.invoke<ListRoomsResponse>(ctx, 'ChatService', 'ListRooms', request, ListRoomsResponse())
  ;
  $async.Future<JoinRoomResponse> joinRoom($pb.ClientContext? ctx, JoinRoomRequest request) =>
    _client.invoke<JoinRoomResponse>(ctx, 'ChatService', 'JoinRoom', request, JoinRoomResponse())
  ;
  $async.Future<LeaveRoomResponse> leaveRoom($pb.ClientContext? ctx, LeaveRoomRequest request) =>
    _client.invoke<LeaveRoomResponse>(ctx, 'ChatService', 'LeaveRoom', request, LeaveRoomResponse())
  ;
}
